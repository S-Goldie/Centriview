...
st.write('The complete theoretical considerations are published open access in [doi link here]. \
...
st.markdown("""
            ...
            and the sediment from this step is retained. In this was, as illustrated, the resulting relative population 
